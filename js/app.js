(() => {
    ...
    function initSliders() {
        const md3 = window.matchMedia("(max-width:991.98px)");
        if (document.querySelector(".swiper")) {
            ...
            let teamSlider;
            const breakpointCheckerMD3 = function() {
                if (false === md3.matches) {
                    if (void 0 !== teamSlider) teamSlider.destroy(true, true);
                    return;
                } else if (true === md3.matches) return enableSwiperMD3();
            };
            const enableSwiperMD3 = function() {
            ...
            md3.addListener(breakpointCheckerMD3);
            breakpointCheckerMD3();
        }
    }
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (window.screen.width >= 1300) if (targetElement.classList.contains("menu__arrow")) targetElement.closest(".menu__item").classList.toggle("_hover"); else if (!e.target.closest(".menu__item._hover")) _removeClasses(document.querySelectorAll(".menu__item"), "_hover");
